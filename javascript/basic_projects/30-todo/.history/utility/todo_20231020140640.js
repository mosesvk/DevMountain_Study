function addTodo() {
  ...
  if (todoText.trim() !== '') {
    ...
    const lists = JSON.parse(localStorage.getItem('data')); // Replace 'your-storage-key' with your storage key
    ...
    if (currentList) {
      ...
      localStorage.setItem('data', JSON.stringify(lists)); // Replace 'your-storage-key' with your storage key
